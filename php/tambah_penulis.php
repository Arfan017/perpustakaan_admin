                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Penulis Baru</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="php/query/addpenulis.php" method="POST">
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-6">
                                        <label for="nama_penulis">Nama Penulis</label>
                                        <input name="nama_penulis" type="text" class="form-control" id="nama_penulis" placeholder="Nama Penulis" required>
                                    </div>
                                    <!-- <div class="form-group col-6">
